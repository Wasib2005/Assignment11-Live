const UserOrderHeader = ({ filterOption, setFilterOption }) => {
  ...
  return (
    <div className="flex items-end -mx-4 overflow-x-auto overflow-y-hidden sm:justify-center flex-nowrap dark:bg-gray-900 dark:text-gray-100 text-gray-800">
      ...
      <p
        ...
        className={`p-2 ${
          filterOption === "Pending" ? "border border-b-0 rounded-t-lg" : "border-b"
        } dark:border-white md:text-2xl font-semibold border-black`}
      >
        Pending
      </p>
      <p
        ...
        className={`p-2 ${
          filterOption === "Received" ? "border border-b-0 rounded-t-lg" : "border-b"
        } dark:border-white md:text-2xl font-semibold border-black`}
      >
        Received
      </p>
      <p
        ...
        className={`p-2 ${
          filterOption === "Successful" ? "border border-b-0 rounded-t-lg" : "border-b"
        } dark:border-white md:text-2xl font-semibold border-black`}
      >
        Successful
      </p>
      <p
        ...
        className={`p-2 ${
          filterOption === "Failed" ? "border border-b-0 rounded-t-lg" : "border-b"
        } dark:border-white md:text-2xl font-semibold border-black`}
      >
        Failed
      </p>
